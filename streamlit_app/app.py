...
metrics = [
    (c1,"180","Juegos","#9f8fff"),
    (c2,"52","Decepciones","#f07060"),
    (c3,"77","Sorpresas","#42d9a8"),
    (c4,str(md["auc_temporal"]),"AUC temporal","#6abf69"),
    (c5,str(threshold)[:5],"Threshold","#f0a442")
]
for col,num,lbl,clr in metrics:
